    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.clear();
                editor.commit();
                Toast.makeText(OneToFifty.this, "Log out successfuly", Toast.LENGTH_SHORT).show();
                openMain();
            }
        });
        ...
        Ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(turn==r) {
                    ...
                    Toast.makeText(OneToFifty.this,"NO",Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    public void OpenWin(){
        Intent intent = new Intent(OneToFifty.this, Win.class);
